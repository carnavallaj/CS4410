...
#    MPlocks and MPcondition variables.
...
class PrinterScheduler(MP):
    ...
    def __init__(self, max_jobs):
        ...
        self.lock = self.Lock('Job Lock')
        self.job_add = self.lock.Condition('Add Monitor')
        self.job_process = self.lock.Condition('Process Monitor')
